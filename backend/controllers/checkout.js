...
//Base URL (payment -> creating an invoice -> copy from that )
...
const createInvoice = async (amount) => {
  try {
    const data = {
      ...
      url_return: "https://mern-stack-donation-page.vercel.app/donate",
      url_success: "https://mern-stack-donation-page.vercel.app/",
      lifetime: 300,
    };
